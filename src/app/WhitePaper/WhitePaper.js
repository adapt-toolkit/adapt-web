            ...
            <div className={styles.container}>
                <section>
                    ...
                    <div className={styles.colRight}>
                        <h2><b>Motivation and vision</b></h2>
                        <button
                ...
                <section>
                    <div className={styles.colLeft}>
                        <img
                            onClick={() => window.open('https://drive.google.com/open?id=1v3s8P9SFgywNsAOaOuemI5Tm3k9-7FN6', '_blank')}
                            className={styles.shadow}
                            src="/images/screenshot_1.jpg"
                        />
                    </div>
                    <div className={styles.colRight}>
                        <h2><b>Architecture Summary</b></h2>
                        <button
                ...
                <section>
                    <div className={styles.colLeft}>
                        <img
                            onClick={() => window.open('https://drive.google.com/file/d/1A64LT5V8s2OE6-CKgCVp-NSxvBoVO65j/view?usp=sharing', '_target')}
                            className={styles.shadow}
                            src="/images/screenshot_2.jpg"
                        />
                    </div>
                    <div className={styles.colRight}>
                        <h2><b>Full White Paper</b></h2>
                        <button
                            className={styles.button}
                            onClick={() => window.open('https://drive.google.com/file/d/1A64LT5V8s2OE6-CKgCVp-NSxvBoVO65j/view?usp=sharing', '_target')}
                        >Download</button>
