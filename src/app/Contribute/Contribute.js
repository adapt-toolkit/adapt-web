        ...
        { acceptPolicy
          ? <div>
              <div className={styles.intro}>
                <p>
                  Because <b>ADAPT</b> is designed to give blockchain developers <b><a href="https://www.evernote.com/OutboundRedirect.action?dest=https%3A%2F%2Fmedium.com%2F%40aleksandr.bulkin%2Fdeath-by-wealth-2cc5d047c412" target="_blank">the most freedom possible</a></b>  it does not impose a token economics of its own. Instead of issuing and selling tokens, we are funding initial stages of development with donations.<br /><br />
                  Contributors may choose to get an Ethereum non-fungible asset (NFT) — <b>unique digital art</b> — as a thank you for their contribution. NFTs are tokens of ownership of digital art recorded on the Ethereum blockchain. Ownership of an NFT unambiguously and forever confirms you as an early contributor to ADAPT. The NFT infrastructure is provided by <b><a href="http://uniqx.io"  target="_blank">UNIQX</a></b> created by our partners at <b><a href="http://135b.io"  target="_blank">135b</a></b>. As 135b builds out their NFT infrastructure further, you’ll be able to gift your digital art to a friend or publicly display it on your social media or homepage.<br /><br />
                  ADAPT is looking to raise $600,000, which would be sufficient to hire one full-time developer in the US and two full-time developers in Ukraine (we already have a team there working on ADAPT part-time), and a dedicated product/marketing person to reach out to perspective dApp developers and other parties interested in the early ADAPT ecosystem. With these resources we are targeting to run our first dApp hackathon with ADAPT in 6 months after the completion of the funding. Some portion of the funds is dedicated as rewards to the participating artists as well as our partners who contributed work to make this effort happen. The full bootstrapping strategy for the ADAPT ecosystem is detailed  <b><a href="https://drive.google.com/file/d/1F94zj_DlYuOmMOq8mQpT4SiWudEVzeAq/view" target="_blank">here</a></b>.<br /><br />
